...
Finally you can also sort your issues according to certain variable (quantitative) and impose sole filtering factors (conditions as in `filter_issues()`), which will be applied one after the other:
