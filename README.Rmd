...
You can install {IssueTrackeR} from [CRAN](https://cran.r-project.org/web/packages/IssueTrackeR/index.html):
...
```{r retrieve, eval = TRUE, echo = TRUE}
# From online
...
```{r set-options, eval = TRUE, echo = TRUE}
...
```{r retriev-local, eval = FALSE, echo = TRUE}
# From local
...
```{r update-database, eval = TRUE, echo = TRUE}
# From online
