...
#> The datasets will be exported to C:\Users\UTZK0M\AppData\Local\Temp\RtmpYd2N2A\list_issues.yaml.

write_labels_to_dataset(
    labels = my_labels, 
    dataset_dir = tempdir()
)
#> The datasets will be exported to C:\Users\UTZK0M\AppData\Local\Temp\RtmpYd2N2A\list_labels.yaml.

write_milestones_to_dataset(
    milestones = my_milestones, 
    dataset_dir = tempdir()
)
#> The datasets will be exported to C:\Users\UTZK0M\AppData\Local\Temp\RtmpYd2N2A\list_milestones.yaml.
```
...
#> 2sRunning gh query ■■■■■■■■■■■■■■■■ 50% | ETA: 2sRunning gh query
